...
{
    [Serializable]
    [CreateAssetMenu(menuName = "Lua API/Entities/Stats/Base Stats/Strength", fileName = "New Strength")]
    public class StrengthSo : BaseStats
    {
        ...
        {
            return Base.BaseStatsType.Strength;
        }
